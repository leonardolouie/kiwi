...
3. `npm install` in the project root folder on web
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/hla8tqi8/settings/api) and create a token with read rights.
